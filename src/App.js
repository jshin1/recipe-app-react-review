...
class App extends Component {
  ...
  filterCategory = (input) => {
    let filtered = this.state.categories.filter(c => c.strCategory.includes(input))
    this.setState({
      filtered: filtered
    })
  }
      ...
      <div>
        ...
        <Row>
          <Col s={4} className='grid-example'>
            <h4>Categories</h4>
            <CategoryContainer findRecipes={this.findRecipes} categories={this.state.categories}/>
          </Col>
